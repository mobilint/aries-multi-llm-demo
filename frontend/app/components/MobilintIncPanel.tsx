  ...
  return (
    ...
    >
      ...
      <IconButton
        ...
        onClick={(e) => !resetDisabled && onReset()}
        sx={{
          padding: "11px",
          backgroundColor: "#003E8A !important",
          borderRadius: "10px",
          color: "#FFFFFFB4",
          ":hover": {
            color: "white",
      ...
      >
        <svg width="25" height="25" viewBox="0 0 23 23" fill="currentColor" xmlns="http://www.w3.org/2000/svg">
